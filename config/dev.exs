...
config :workspace, WorkspaceWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "lBAAFopgfMw95Qw3eX5XT1KpxYPX/brN5arZG8iCTcYWgodPnQcchRYFvg72ERnk",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:workspace, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:workspace, ~w(--watch)]}
  ]
...
config :workspace, WorkspaceWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/workspace_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :workspace, dev_routes: true
